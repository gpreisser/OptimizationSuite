...
function runs_dir(base_dir; L, sweeps_per_attempt, percentage, maxdim, sample_mode, track, early_stop_at_one, tol)
    tag = "L$(L)_sw$(sweeps_per_attempt)_pct$(percentage)_maxd$(maxdim)_mode$(sample_mode)" *
...
# solver params (YOU WERE MISSING THESE)
